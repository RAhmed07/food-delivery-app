...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({Key? key, this.onPressed, required this.buttonText,  this.transparent=false, this.margin, this.height, this.width, this.fontSize,  this.radius=5, this.icon}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            icon !=null?Padding(
              ...
              Theme.of(context).cardColor,),):const SizedBox(),
