      ...
      body: Center(
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Icon(status==1? Icons.check_circle_outline: Icons.warning_amber_outlined,size:Dimensions.height20*5,color: AppColor.mainColor,),
              ...
              Padding(padding: EdgeInsets.all(Dimensions.height10),
                child: CustomButton(buttonText: 'Back to Home',onPressed: ()=>Get.offNamed(RouteHelper.initial),),
              )
            ],
          ),
        ),
